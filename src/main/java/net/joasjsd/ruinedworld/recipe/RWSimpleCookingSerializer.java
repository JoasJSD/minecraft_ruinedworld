...
public class RWSimpleCookingSerializer<T extends RWAbstractCookingRecipe> implements RWRecipeSerializer<T> {
    private final int defaultCookingTime;
    private final RWSimpleCookingSerializer.CookieBaker<T> factory;

    public RWSimpleCookingSerializer(RWSimpleCookingSerializer.CookieBaker<T> p_44330_, int p_44331_) {
    ...
    @Override
    public void toNetwork(FriendlyByteBuf p_44101_, Recipe p_44102_) {

    }

    public void toNetwork(FriendlyByteBuf p_44335_, T p_44336_) {
        p_44335_.writeUtf(p_44336_.getGroup());
        p_44335_.writeEnum(p_44336_.category());
        p_44336_.ingredient.toNetwork(p_44335_);
        p_44335_.writeItem(p_44336_.result);
        p_44335_.writeFloat(p_44336_.getExperience());
        p_44335_.writeVarInt(p_44336_.getCookingTime());
    }

    interface CookieBaker<T extends RWAbstractCookingRecipe> {
