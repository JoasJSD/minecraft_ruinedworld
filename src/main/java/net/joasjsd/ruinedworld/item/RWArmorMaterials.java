...
public enum RWArmorMaterials implements ArmorMaterial {
    ROBIUM("robium", 40, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266649_) -> {
    ...
    }), 31, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 1.0F, () -> {
        return Ingredient.of(RWItems.ROBIUM_INGOT.get());
    });
    ...
    private RWArmorMaterials(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
        this.name = p_268171_;
    ...
    public String getName() {
        return RuinedWorld.MODID + ":" + this.name;
    }
